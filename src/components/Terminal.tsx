...
Ready for input...`,
  ...
  return (
    <div className="min-h-screen bg-terminal-bg flex items-center justify-center p-4">
      <div className="terminal-window w-full max-w-6xl h-[90vh]">
        ...
        <div className="terminal-header px-4 py-3 flex items-center">
          ...
          <span className="text-terminal-comment text-sm font-bold">Terminal — bash — 80×24</span>
          <div className="ml-auto text-terminal-comment text-sm">◐ ◑ ◒</div>
        </div>
        ...
        <div className="terminal-content flex flex-col h-full">
          ...
          >
            ...
            {history.map((item, index) => (
              <div key={index}>
                ...
                <div className={`terminal-output whitespace-pre-wrap ${getOutputColor(item.output.type)} pl-0 mb-2`}>
                  {item.output.content}
                </div>
              </div>
            ))}
          ...
          {/* Input area */}
          <div className="px-4 py-2 border-t border-terminal-comment/20 bg-terminal-surface/50">
            <form onSubmit={handleSubmit} className="terminal-line">
              ...
              <input
                ...
                className="bg-transparent border-none outline-none flex-1 text-terminal-text caret-terminal-text font-mono"
                disabled={isLoading}
                autoComplete="off"
                spellCheck="false"
